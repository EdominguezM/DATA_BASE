...
--pregunta 9 parte ii
CREATE TABLE comentarios(id SERIAL PRIMARY KEY, fecha_y_hora TIMESTAMP contenido VARCHAR(500), post_id INT,FOREIGN KEY(post_id) REFERENCES post(id));
...
INSERT INTO comentarios(fecha_y_hora, contenido, post_id) VALUES('2020-06-20 16:00' , 'comentario carlos1',4), ('2020-06-20', '17:00' , 'comentario carlos2',4), ('2020-06-20 18:00' , 'comentario carlos3',4), ('2020-06-20 19:00' , 'comentario carlos4',4) ;
